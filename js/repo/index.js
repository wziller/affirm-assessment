...
export class ManualOverrideRepo {
  static get = async (ssn, override_type) =>
    ManualOverride.findOne({ where: { ssn, override_type } });
  static does_customer_have_override = async (ssn, override_type) =>
    !!(await this.get(ssn, override_type));
}
